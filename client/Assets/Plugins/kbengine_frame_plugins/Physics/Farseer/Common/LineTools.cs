...
namespace SyncFrame.Physics2D
{
    ...
    public static class LineTools
    {
        ...
        public static bool LineIntersect2(ref TSVector2 a0, ref TSVector2 a1, ref TSVector2 b0, ref  TSVector2 b1, out TSVector2 intersectionPoint)
        {
            ...
            //AABB early exit
            if (SyncFrame.TSMath.Max(x1, x2) < SyncFrame.TSMath.Min(x3, x4) || SyncFrame.TSMath.Max(x3, x4) < SyncFrame.TSMath.Min(x1, x2))
                return false;

            if (SyncFrame.TSMath.Max(y1, y2) < SyncFrame.TSMath.Min(y3, y4) || SyncFrame.TSMath.Max(y3, y4) < SyncFrame.TSMath.Min(y1, y2))
                return false;
