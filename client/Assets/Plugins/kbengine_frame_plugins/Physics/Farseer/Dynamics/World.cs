...
namespace SyncFrame.Physics2D
{
    ...
    /// </summary>
    public class World : SyncFrame.IWorld
    {
        internal FP _invDt0;
            ...
            for (; ; )
            {
                ...
                for (int i = 0; i < ContactManager.ContactList.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            alpha = SyncFrame.TSMath.Min(alpha0 + (1.0f - alpha0) * beta, 1.0f);
                        }
                        else
                        {
                            alpha = 1.0f;
        ...
        public List<SyncFrame.IBody> Bodies() {
            List<SyncFrame.IBody> bodies = new List<SyncFrame.IBody>();
            for (int index = 0; index < BodyList.Count; index++) {
